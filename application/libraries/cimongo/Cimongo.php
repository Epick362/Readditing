...
class Cimongo extends Cimongo_extras {
        ...
        public function like($field = "", $value = "", $flags = "iu", $enable_start_wildcard = TRUE, $enable_end_wildcard = TRUE) {
                $field = trim($field);
                $this->_where_init($field);
                $value = trim($value);
                ...
                $valueedit = $this->accentToRegex($value); //new MongoRegex("/.*{$search}.*/i"));
                $regex = "/$valueedit/$flags";
                $this->wheres[$field] = new MongoRegex($this->accentToRegex($value)); //MongoRegex($regex);
                return $this;
        }
