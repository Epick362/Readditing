	...
	<div class="media-body">
		...
		?>
			<div class="media">
				...
				<div class="media-body">
					<h4 class="media-heading"><?=anchor(base_url('user/'.$reply->data->author), $reply->data->author)?></h4>
				...
				?>
					<div class="media">
						...
						<div class="media-body">
							<h4 class="media-heading"><?=anchor(base_url('user/'.$reply2->data->author), $reply2->data->author)?></h4>
