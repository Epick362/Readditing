<div id="wrap">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-user icon-large"></i> epick_362 <b class="caret"></b></a>
	...
	<div class="container content">
		<div class="jumbotron">
			...
			<img src="<?=base_url('assets/img/preview1.gif')?>" />
		</div>
		<div class="jumbotron">
			<h2>CodeIgniter Bootstrap</h2>
		...
		<div class="jumbotron">
			<h2>CodeIgniter Bootstrap</h2>
			<img src="<?=base_url('assets/img/preview3.gif')?>" />
		</div>
		<div class="jumbotron">
			<h2>CodeIgniter Bootstrap</h2>
			<img src="<?=base_url('assets/img/preview2.gif')?>" />
		</div>
	</div>
</div>
<div id="footer">
	<div class="container">
		<p class="text-muted credit">RedditReader v0.1. Copyright &copy; Filip Hajek.</p>
	</div>
</div>